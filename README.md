...
1. Clone the repository:
   ...
   git clone https://github.com/CodebyLK/CodebyLK.github.io.git


2.  Navigate into the project directory.
3.  Open `index.html` in your preferred web browser, or use a tool like VS Code's "Live Server" extension for hot-reloading during development.
